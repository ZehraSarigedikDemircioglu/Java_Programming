...
public class BulkOperations {
    ...
    public static void main(String[] args) {
        ...
        students.add(2,"Tatiana");
        System.out.println(students); // [Gadir, Hasan, Tatiana, Shukur, Sumeye, Tatiana, Abidullah, Bilal]
        ...
        //l1.addAll(Arrays.asList(nums)); // [1, 2, 3, 4, 5, 6, 7, 8]
        ...
        System.out.println(list); // [10, 10, 20, 30, 40, 50, 60, 70, 10, 10, 10, 10, 20, 20, 20, 20]

        list.removeAll(Arrays.asList(10));
        System.out.println(list); // [20, 30, 40, 50, 60, 70, 20, 20, 20, 20]

        list.removeAll(Arrays.asList(20,30));
        System.out.println(list); // [40, 50, 60, 70]
       ...
       // developers.retainAll(Arrays.asList("Alena","Khashayar"));
        ...
        System.out.println(groceriesList); // [Eggs, Potato, Milk, Tomato, Rice, Orange, Strawberry, Blueberry, Paper towels]

       // groceriesList.removeAll(Arrays.asList("Milk", "Rice"));
       // System.out.println(groceriesList); // [Eggs, Potato, Tomato, Orange, Strawberry, Blueberry, Paper towels]

        groceriesList.retainAll(Arrays.asList("Eggs", "Orange", "Paper towels"));
        System.out.println(groceriesList); // [Eggs, Orange, Paper towels]
