...
public class MapPractice2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(person3.get("job_title"));
        ...
        for (Map<String, Object> eachMap : listOfMaps) {
            for (Map.Entry<String, Object> each : eachMap.entrySet()) {
                if(each.getKey().equals("hired_date")){
                    if(((LocalDate)each.getValue()).getYear()==2022){
